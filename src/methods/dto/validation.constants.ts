...
export const DYNAMIC_ACTION_NAME_MAX_LENGTH = 160;
export const DYNAMIC_STEP_NAME_MAX_LENGTH = 120;
export const DYNAMIC_ACTION_ITEMS_MAX_COUNT = 200;
export const CYCLE_STEPS_MAX_COUNT = 500;
export const MAX_DYNAMIC_ROLL_INTERVAL_TICKS = 100_000;
export const MAX_DYNAMIC_STEP_TICKS = 1_000_000;
