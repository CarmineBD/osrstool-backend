...
export class VariantSnapshotService {
  ...
  async createFromVariant(
    ...
    const snapshot = this.repo.create({
      ...
      label: variant.label,
      actionsPerHour: variant.actionsPerHour ?? undefined,
      actionType: variant.actionType,
      xpHour: variant.xpHour ?? undefined,
      clickIntensity: variant.clickIntensity ?? undefined,
      afkiness: variant.afkiness ?? undefined,
